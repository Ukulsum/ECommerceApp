    ...
    public class CustomerService
    {
        ...
        public async Task<ApiResponse<LoginResponseDTO>> LoginAsync(LoginDTO loginDto)
        {
            try
            {
                ...
                var customer = await _context.Customers.AsNoTracking().FirstOrDefaultAsync(c => c.Email == loginDto.Email);
        ...
        public async Task<ApiResponse<ConfirmationResponseDTO>> ChangePasswordAsync(ChangePasswordDTO changePasswordDto)
        {
            try
            {
                ...
                bool isCurrentPasswordValid = BCrypt.Net.BCrypt.Verify(changePasswordDto.ConfirmPassword, customer.Password);
